    ...
    <div class="loginMain">
        <div class="loginSec">
            ...
            <div class="loginFormBox">
                ...
                <form method="post" action="{{ route('forgot_password_otp_check') }}">
                    @csrf
                    <div class="mb-4">
                        <label class="form-label">Email/Mobile Number</label>
                        <input class="form-control w-100" type="text" id="id" name="id" placeholder=""
                            readonly value="{{ old('id', $userId) }}" autocomplete="id" autofocus>
                    </div>

                    <a href="{{ route('forgot_password') }}" class="textUnderline mb-3">Change Email or Mobile Number</a>
                    ...
                    {{-- <input id="otp" type="otp" class="form-control w-100 " name="otp" value="{{ old('otp') }}" required autocomplete="otp" autofocus> 
                    @if (session('error'))
                ...
                <div class="otpMain">
                    ...
                    <div class="otpFind">
                        ...
                        @for ($i = 0; $i < 6; $i++)
                            <input type="text" class="form-control otp-input" maxlength="1" name="otp[]"
                                value="{{ old('otp') }}" required oninput="handleInput(this, {{ $i }})" autocomplete="off" />
                        @endfor
                    </div>
                    @if (isset($error))
                    <span class="error-msg" role="alert">
                    ...
                    <strong class="signupTxt pb-0">Didn't get a code?
